...
agnoli <- read_excel ("Makel_Agnoli/Agnoli_ItalianData/ItalianQRPData.xlsx", skip=2)

library(dplyr)
library(tidyr)
library(ggplot2)

relevant<- agnoli %>% select_at(vars(ends_with("have adopted this practice"),starts_with("In a research article")))
