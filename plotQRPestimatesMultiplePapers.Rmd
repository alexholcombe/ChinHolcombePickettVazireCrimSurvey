...
#Agnoli has ""Reporting only studies that worked" but Rabelo does not.
```
...
omitExtraAgnoli <- CMAF %>% filter(practiceStandardName != "Mislead about demographic\nvariable effects") %>%
      ...
      filter(practiceStandardName != "Reporting only studies that worked\n(closest to Omit n.s. studies or variables)")  
