...
write.csv(career, file = "demographics_careerlevel.csv")
...
write.csv(classes, file = "demographics_careerlevel.csv")
...
selfuse_quant$var <- sub("hidingproblems", "Hide data problems", selfuse_quant$var)
selfuse_quant$var <- sub("fillingin", "Hide imputation", selfuse_quant$var)

selfuse_quant

write.csv(selfuse_quant, file = "selfuse_quant.csv")
...
selfusepercent_quant$var <- sub("hidingproblems", "Hide data problems", selfusepercent_quant$var)
selfusepercent_quant$var <- sub("fillingin", "Hide imputation", selfusepercent_quant$var)

selfusepercent_quant

write.csv(selfusepercent_quant, file = "selfusepercent_quant.csv")
...
write.csv(selfuse_all, file = "selfuse_all.csv")
...
write.csv(selfusepercent_all, file = "selfusepercent_all.csv")
...
write.csv(selfuse_nonquant, file = "selfuse_nonquant.csv")
...
write.csv(selfusepercent_nonquant, file = "selfusepercent_nonquant.csv")
...
endorse_quant$var <- sub("hidingproblems", "Hide data problems", endorse_quant$var)
endorse_quant$var <- sub("fillingin", "Hide imputation", endorse_quant$var)

endorse_quant

write.csv(endorse_quant, file = "endorse_quant.csv")
...
write.csv(endorse_all, file = "endorse_all.csv")
...
write.csv(endorse_nonquant, file = "endorse_nonquant.csv")
...
write.csv(endorse_quant_simine, file = "endorse_quant_simine.csv")
...
ggplot( drop_na(longQRPs), aes(practiceLongName,fill=response)) + 
...
ggsave("OSPsStackedBarChart.png", width = 30, height = 20, units = "cm")
...
write.table(tq, file = "QRPsupportTable.txt", sep = "\t", quote = FALSE, row.names = T)
...
to<- drop_na(longOSPs) %>%
  ...
  relocate(practiceLongName,response,percentRounded)
show(to)
write.table(to, file = "OSPsupportTable.txt", sep = "\t", quote = FALSE, row.names = T)
...
ggsave("fig1_endorseother.png", width = 30, height = 20, units = "cm")
...
ggsave("fig1alt_other.png", width = 30, height = 20, units = "cm")
...
ggsave("fig2_endorseother.png", width = 30, height = 20, units = "cm")
...
ggsave("fig2alt_other.png", width = 30, height = 20, units = "cm")
...
show(QRPprevCloud)
ggsave("QRPperceivedPrevalenceCloud.png", width = 30, height = 20, units = "cm")
```
...
show(OSPprevCloud)
ggsave("OSPperceivedPrevalenceCloud.png", width = 30, height = 20, units = "cm")
```
...
ggsave("fig1all_endorseother.png", width = 30, height = 20, units = "cm")
...
ggsave("fig1nonquant_endorseother.png", width = 30, height = 20, units = "cm")
...
ggsave("fig2all_endorseother.png", width = 30, height = 20, units = "cm")
...
ggsave("fig2non_endorseother.png", width = 30, height = 20, units = "cm")
