...
selfuse_quant$var <- sub("biasedAttempt replicationorting", "Omit nonsignificant studies or variables", selfuse_quant$var)
...
selfusepercent_quant$var <- sub("biasedAttempt replicationorting", "Omit nonsignificant studies or variables", selfusepercent_quant$var)
...
endorse_quant$var <- sub("biasedAttempt replicationorting", "Omit nonsignificant studies or variables", endorse_quant$var)
...
longQRPs <- longQRPs %>% mutate(
  practiceLongName = case_when(
    practice=="biasedreporting_should" ~ "Omit nonsignificant studies or variables",
...
aspredicted_endorse <- QORP_quant %>% 
  ...
  dplyr::rename(x=sum) %>% mutate(mean=x/n)
...
endorse_other$var <- sub("biasedreporting", "Omit nonsignificant studies or variables", endorse_other$var)
...
endorse_other$var <- sub("hidingproblems", "Hide problems", endorse_other$var)
...
others$var <- sub("biasedreporting", "Omit nonsignificant studies or variables", others$var)
...
endorse_other <- endorse_other %>% dplyr::rename(Question = type)
...
longQRPprevalence <- longQRPprevalence %>% mutate(
  practiceLongName = case_when(
    practice=="biasedreporting_others" ~ "Omit nonsignificant studies or variables",
...
practiceOrderDesiredNeverAscending <- c(4,5,7,3,2,1,8,9,10) 
